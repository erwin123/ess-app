...
export class AccountService {
  ...
  putAccount(obj) {
    ...
    return this.httpClient
      .put<any>(this.config.Api.global_api + "/account", obj, {
  ...
  login(username, password) {
    ...
    return this.httpClient
      .post<any>(
        this.config.Api.global_api + "/account/login",
  ...
  chPwd(obj) {
    return this.httpClient
      .post<any>(this.config.Api.global_api + "/account/chpwd", obj, {
        headers: this.headers
      })
      .pipe(
        retry(3),
  ...
  resetPwd(obj) {
    ...
    return this.httpClient
      .post<any>(this.config.Api.global_api + "/account/resetpwd", objPut, {
        headers: this.headers
      })
      .pipe(
        retry(3),
